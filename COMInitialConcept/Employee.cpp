...
void Employee::storeEmployee(const string& filename) {
...
void Employee::retrieveEmployeeById(const string& searchId, const string& filename) {
...
void Employee::retrieveEmployeeByName(const string& searchName, const string& filename) {
    ifstream file(filename, ios::binary);
    if (file.is_open()) {
        size_t idSize;
        size_t nameSize;
