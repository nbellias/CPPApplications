...
void Department::storeDepartment(const string& filename) {
...
void Department::retrieveDepartmentById(const string& searchId, const string& filename) {
...
void Department::retrieveDepartmentByName(const string& searchName, const string& filename) {
    ifstream file(filename, ios::binary);
    if (file.is_open()) {
        size_t idSize;
        size_t nameSize;
